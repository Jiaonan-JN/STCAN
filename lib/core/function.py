...
from .loss import loss_function_ab, loss_function_af
from .utils_box import reg2loc
from .ab_match import anchor_box_adjust, anchor_bboxes_encode
from .utils_ab import result_process_ab, result_process_af
from .utils_af import get_targets_af, get_points
...
def train(cfg, train_loader, model, optimizer):
    ...
    for feat_spa, feat_tem, boxes, label, action_num in train_loader:
        ...
        # Anchor-free module loss function
        ########################################################################################################################
